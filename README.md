...
wheel zooms, P/Esc pauses. "Unlock All" buttons on the champion/realm screens
open everything immediately (also triggers the Pilgrim mission). The camera smoothly follows the hero's body-center;
